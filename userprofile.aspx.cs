    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                {
                    Label1.Attributes.Add("class", "rounded-pill bg-success");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "pending")
                {
                    Label1.Attributes.Add("class", "rounded-pill bg-warning");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "deactive")
                {
                    Label1.Attributes.Add("class", "rounded-pill bg-danger");
                }
                else
                {
                    Label1.Attributes.Add("class", "rounded-pill bg-info");
                }
